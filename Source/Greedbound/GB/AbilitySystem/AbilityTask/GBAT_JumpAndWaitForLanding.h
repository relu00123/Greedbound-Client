...
#include "GBAT_JumpAndWaitForLanding.generated.h"

DECLARE_DYNAMIC_MULTICAST_DELEGATE(FJumpAndWaitForLandingDelegate);

UCLASS()
class GREEDBOUND_API UGBAT_JumpAndWaitForLanding : public UAbilityTask
{
    GENERATED_BODY()
...
private:
    ...
    static UGBAT_JumpAndWaitForLanding* CreateTask(UGameplayAbility* OwningAbility);
